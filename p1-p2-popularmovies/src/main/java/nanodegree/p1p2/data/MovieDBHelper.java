...
public class MovieDBHelper extends SQLiteOpenHelper{
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + MovieContract.MovieEntry.TABLE_NAME + " (" +
                    ...
                    MovieContract.MovieEntry.COLUMN_NAME_ID + TEXT_TYPE + COMMA_SEP +
                    MovieContract.MovieEntry.COLUMN_NAME_POSTER_BYTES + BLOB_TYPE + COMMA_SEP +
                    MovieContract.MovieEntry.COLUMN_NAME_POSTER_PATH + TEXT_TYPE + COMMA_SEP +
                    MovieContract.MovieEntry.COLUMN_NAME_ADULT + TEXT_TYPE + COMMA_SEP +
                    ...
                    MovieContract.MovieEntry.COLUMN_NAME_GENRE_IDS + TEXT_TYPE + COMMA_SEP +
                    ...
                    MovieContract.MovieEntry.COLUMN_NAME_POPULARITY + TEXT_TYPE + COMMA_SEP +
                    MovieContract.MovieEntry.COLUMN_NAME_VOTE_COUNT + TEXT_TYPE + COMMA_SEP +
                    MovieContract.MovieEntry.COLUMN_NAME_VIDEO + TEXT_TYPE + COMMA_SEP +
                    MovieContract.MovieEntry.COLUMN_NAME_VOTE_AVERAGE + TEXT_TYPE +
            " )";
